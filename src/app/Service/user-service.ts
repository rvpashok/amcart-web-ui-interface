...
export class UserService{
    ...
    fetchProfileDetails(profileId:string, accessToken:string){
            ...
            //return this.http.get<SearchSuggestionsResults>("https://ojx3smmf5b.execute-api.ap-south-1.amazonaws.com/orchestrationservices/api/users/" + profileId + "/profiles",
